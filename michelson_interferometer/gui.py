...
class MainWindow(Adw.ApplicationWindow):
    ...
    plot_mode: Adw.ToggleGroup = Gtk.Template.Child()
    ...
    def _register_about_action(self) -> None:
        ...
        action.connect(
            "activate",
            lambda action, param: self.about_dialog.present(),  # pyright: ignore[reportUnknownArgumentType]
        )
    ...
    def _initialize_position_adjustment(self) -> None:
        ...
        gesture.connect("pressed", self._on_position_gesture_pressed)  # pyright: ignore[reportUnknownArgumentType]
        gesture.connect("released", self._on_position_gesture_released)  # pyright: ignore[reportUnknownArgumentType]
    ...
    @Gtk.Template.Callback()
    def home_motor(self, button: Adw.ButtonRow) -> None:
    ...
    def on_save_dialog_response(
        ...
        if file is None:  # pyright: ignore[reportUnnecessaryComparison]
            return
    ...
    def update_detector(self, value: int) -> None:
        """Update the detector value display."""
